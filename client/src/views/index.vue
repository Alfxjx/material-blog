<template>
 <div>
   <div class="index md-layout md-gutter md-alignment-center">
     ...
     <div class="md-layout-item md-large-size-20 md-medium-size-33 md-small-hide md-alignment-top-right">
